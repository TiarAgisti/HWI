...
Partial Class pagesetting_MsPageDC
    ...
    Protected Sub pg_closing()
        ...
        Dim strDays As Integer, strDays1 As Integer, blne As Integer, bln1 As Integer, thn1 As Integer, _
            wulupdateharian As Integer, nuhunupdateharian As Integer, _
            wulupdateharian1 As Integer, nuhunupdateharian1 As Integer, tgltupo_akhir As Integer, _
            bulclos As Integer, tahunclos As Integer, wulnow As Integer, nahunnow As Integer, _
            gal1 As Integer, gal2 As Integer, gal3 As Integer, tgltupo_awal As Integer, blntupo_awal As Integer, _
