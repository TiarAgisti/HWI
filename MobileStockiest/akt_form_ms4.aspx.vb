...
Partial Class MobileStockiest_akt_form_ms4
    ...
    Protected noinvo, sort, pos_area, mypos, loguser, noser, nama, paket, alok, psa, direk, l23, namadirek, telpdirek, l26, aloc As String
    Protected namaalo, notelpalo, uprane, ada, l25, kaki, kakiku, pp, prop_dc As String
    Protected jumbc, subalo, minimal, kl, blnskr, thnskr As Double

    Protected error1, error2, error3, error6, error7, error8, error9, error10, error11, error12, error13, error14 As String
