...
Partial Class MobileStockiest_sale_cetak_invoice_prd
    ...
    Dim pos_area, mypos, loguser, tipe, namadist, namadist1, nodist, nodist1, lanjut, nopos, nokon1 As String
    Dim kta, noslip, nokode, nama As String
    Dim subtot, PV, bv, kepiro, jume, harga, noke, totbruto As Double
    ...
    Dim kdd1, kdd2, undi, ss As String
    Dim mbahpv, xcs, ke As Double
    ...
    Protected perush_dc, nama_dc, no_dc, alamat_dc, alamat_dc2, telp_dc, emel_dc, web_dc, judul, nopajak, noinvo, nokon, namakon, namakasir, periodelama, autoupgrade, adanomor, adanomortg, noalok, namalok, tpe, ketxtra As String
    ...
    Protected tunai, debit, cc, vouc, jumbayar, kembalian, alokbulan, aloktahun, pvmbah, jumdisk, subtote As Double
