...
Partial Class MobileStockiest_mb4_perdana
    ...
    Dim namatabel, namatabel2, zona_id, kti, sort, pos_area, loguser, kelasdc, indukdc As String
    Dim asal, nodc, tglorder, nofax, namadc, namadis_mc, nokode_mc As String
