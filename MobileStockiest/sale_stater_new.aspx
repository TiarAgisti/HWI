...
<asp:Content ID="Content2" ContentPlaceHolderID="mpCONTENT" runat="Server">
    <section class="content-header" style="background-color:white;">
        <div style="background-color: gray">
            <h3 style="text-align:center;color:white;font-family:Arial;"><strong>NEW PENDAFTARAN DISTRIBUTOR BARU</strong></h3>
        </div>
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            ...
                            <br>
                                    ...
                                    <li><span style="color: red"><b>PASTIKAN</b></span>
                                    bahwa nomor id distributor yang menjadi sponsornya (direct sponsor) maupun upline penempatan sudah terdaftar (sudah menjadi distributor HWI) dengan tanda munculnya nama di kotak direct sponsor dan upline penempatan.
            ...
            <div class="col-md-12">
                <div style="padding: 10px 35px 5px 35px">
                    <div class="alert alert-warning text-center" role="alert">
                        <h4 style="text-align:center;"><span style="text-decoration: underline;"><b>ERROR MESSAGE</b></span></h4>
                    </div>
                </div>
