                                        ...
                                        <div class="col-md-5 col-md-offset-4">
                                            <div class="panel panel-default height">
                                                <div class="panel-heading">
                                                    ...
                                                    <strong>INVOICE PENDAFTARAN MOBILE CENTER</strong>
                                                    <%else%>
                                                    <strong>INVOICE ORDER PRODUK MOBILE CENTER</strong>
                                                    <%end if%>
                                                </div>
                                                <div class="panel-body">
                                                    <table border="0">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>&nbsp;:&nbsp;</td>
                                                                <td><%=nomc%> : <%=ucase(namamc)%></td>
                                                            </tr>
                                                            <%if asale = "perdana" then %>
                                                            <tr>
                                                                <td style="text-align:left;">Username Login</td>
                                                                <td>&nbsp;:&nbsp;</td>
                                                                <td><%=ucase(namauser)%></td>
                                                            </tr>
                                                            <%end if%>	
                                                            <tr>
				                            ...
				                            <table class="table table-condensed">
					                            ...
					                            <tfoot>
                                                    <tr>
							                            ...
							                            <td class="table-bordered highrow text-right"><%=FormatNumber(diskon, 2)%>%&nbsp;&nbsp;</td>
						                            </tr>
						                            <tr>
							                            ...
							                            <td class="table-bordered emptyrow text-right"><strong>Rp <%=FormatNumber(gtot, 0)%>,-&nbsp;&nbsp;</strong></td>
						                            </tr>
						                            <tr>
							                            <td class="emptyrow"></td>
							                            <td class="emptyrow"></td>
