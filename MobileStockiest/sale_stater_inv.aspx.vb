...
Partial Class MobileStockiest_sale_stater_inv
    ...
    Dim pos_area, mypos, pak, kelasdc, indukdc, indukmc, namatabel, namatabel2, noinvoice, mypus As String
    Dim nopos, kta, noslip, tpe As String
    Dim bv As Double

    Dim email, telp, noktp, nama, kop, direk, alok, pose, upme, pase As String
    ...
    Protected alokbulan, aloktahun, harga, PV, tunai, debit, cc, vouc, jumbayar, kembalian As Double
    Protected produk1, produk2, produk3, produk4, produk5, produk6, produk7, produk8, produk9, produk10, produk11, produk12 As String
    Protected lanjut, perush_dc, nama_dc, no_dc, alamat_dc, alamat_dc2, telp_dc, emel_dc, web_dc, judul, nopajak, noinvo, noseri, namakon, loguser, namapaket, paket As String
    ...
    Sub PrepareData()
        ...
        noinvoice = Session("noinvo_akt")
        mypus = Session("nopos_akt")
        Session("noinvo_akt") = ""
        Session("nopos_akt") = ""
        Session("errorpos") = ""
        Session("noinvo_akt") = ""
