...
Partial Class MobileStockiest_sale_renewal
    ...
    Protected mesej, pp, namatabel, dcpusate, mypos, loguser As String
    Protected tgl, hariakhir, tutup1, tutup2 As Date
    Dim pos_area, kelasdc, indukdc, indukmc, dcHO, namatabel2 As String
    Protected minimal As Integer
