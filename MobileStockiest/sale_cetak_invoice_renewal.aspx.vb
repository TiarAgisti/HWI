...
Partial Class MobileStockiest_sale_cetak_invoice_renewal
    ...
    Dim pos_area, mypos, pak, kelasdc, indukdc, indukmc, namatabel, namatabel2, dcpusat As String
    Dim nopos, kta, noslip As String
    ...
    Protected lanjut, perush_dc, nama_dc, no_dc, alamat_dc, alamat_dc2, telp_dc, emel_dc, web_dc, nopajak, noinvo, noseri, namakon, loguser As String
    Protected namapaket, paket As String
