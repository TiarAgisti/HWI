                            ...
                            <div class="panel panel-default height">
                                ...
                                <div class="panel-body">
                                    <table border="0">
                                        <tbody>
                                            <tr>
                                                <td colspan="3" class="text-center">Bulan PV: <%=MonthName(alokbulan)%>&nbsp;<%=aloktahun%></td>
                                            </tr>
                                            <tr>
				            ...
				            <table class="table table-condensed">
					            ...
					            <tbody class="table table-bordered">
						            ...
						            <tr>
							            ...
							            <td colspan="2" class="table-bordered text-right"><label style="color:#000000;"><b><%=FormatNumber(totpv + pvmbah, 2)%>&nbsp;&nbsp;</b></label></td>
					            ...
					            <tfoot>
                                    ...
                                    <tr>
							            ...
							            <td class="table-bordered highrow text-right">Rp <%=FormatNumber(jumdisk, 0)%>,-&nbsp;&nbsp;</td>
						            </tr>
						            <tr>
