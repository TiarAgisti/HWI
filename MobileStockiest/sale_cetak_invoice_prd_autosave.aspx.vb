...
Partial Class MobileStockiest_sale_cetak_invoice_prd_autosave
    ...
    Dim pos_area, mypos, loguser, tipe, namadist, namadist1, nodist, nodist1, lanjut, nopos, nokon1, tpe As String
    Dim kta, noslip, noalok, namalok, nokode, nama As String
    Dim subtot, PV, bv, alokbulan, aloktahun, kepiro, jume, harga, noke As Double
    Dim jumbr1, jumbr2, jumbr3, jumbr4, jumbr5, jumbr6, jumbr7 As Double
    Dim bv1, bv2, bv3, bv4, bv5, bv6, bv7 As Double
    Dim totbv, totbv1, totbv2, totbv3, totbv4, totbv5, totbv6, totbv7 As Double

    Protected noundi1, noundi2, noundi3, noundi4, noundi5, noundi6, noundi7, noundi8, noundi9, noundi10, noundi11, noundi12, noundi13, noundi14, noundi15, noundi16, noundi17, noundi18, noundi19, noundi20 As Long
    ...
    Protected perush_dc, nama_dc, no_dc, alamat_dc, alamat_dc2, telp_dc, emel_dc, web_dc, judul, nopajak, noinvo, nokon, namakon, namakasir, periodelama, autoupgrade, adanomor, adanomortg As String
    Protected efekbulan, efektahun, efekbulan2, efektahun2, pvbulanan As Double
    Protected tglnya, tgl As Date
    Protected no1, no2, no3, no4, no5, no6, no7, kdbr1, kdbr2, kdbr3, kdbr4, kdbr5, kdbr6, kdbr7, namabr1, namabr2, namabr3, namabr4, namabr5, namabr6, namabr7 As String
    Protected totjum, jumlah1, jumlah2, jumlah3, jumlah4, jumlah5, jumlah6, jumlah7, subtot1, subtot2, subtot3, subtot4, subtot5, subtot6, subtot7, gtot As Double
    Protected pv1, pv2, pv3, pv4, pv5, pv6, pv7, totpv, totpv1, totpv2, totpv3, totpv4, totpv5, totpv6, totpv7, harga1, harga2, harga3, harga4, harga5, harga6, harga7 As Double
    Protected tunai, debit, cc, vouc, jumbayar, kembalian As Double
