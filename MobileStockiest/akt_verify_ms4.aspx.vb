...
Partial Class MobileStockiest_akt_verify_ms4
    ...
    Dim sort, pos_area, mypos, loguser, pase, konfi As String
    Dim strDayes, muter, aax As Integer
    Dim subalo, nocross, aloce, sopokui As String
    ...
    Protected error1, error2, error3, error4, error5, error6, error7, error8, error9, error10, error11, error12, error13, error14, error15, error16, error17, error18, error19, error20 As String
    ...
    Protected direk, namadirek, notelpdirek, tempat, kakidirek, kakiupline, idupline, notelpalo, psa, uprane, terusane, kedua, bcdirek, bcupline, ncrd, noinvo As String

    Protected paket, nama, nktp, kelamin, tgllahir, bulanlahir, tahunlahir, alamat, kota, propinsi, kodepos, aloc, namaalo, telpdirek As String
    Protected surat, kotasurat, propinsisurat, kodepossurat, notelp, nohape, pasangan, ahliwaris, hubwaris, eml, bnk, nrk, namarek, npwp, emel, piye, pose As String
    Protected jumbc As Integer
    ...
    Sub PrepareDisplay()
        ...
        Else
            If IsNumeric(jumbc) = False Then
                ...
                error3 = "Anda belum mengisi jumlah BC"
            Else
                If ((jumbc <> 0) And (IsNumeric(jumbc) = True)) Then
                    l3 = "Ter3"
                    error3 = ""
                End If
            End If
        ...
        Else
            ...
            Else
                If ((Len(nktp) <= 31) And (nktp <> "")) Then
                    mlSQL = "SELECT ktp,kta FROM member WHERE ktp LIKE '" & nktp & "'"
        ...
        If CInt(bulanlahir) = 1 Or CInt(bulanlahir) = 3 Or CInt(bulanlahir) = 5 Or CInt(bulanlahir) = 7 Or CInt(bulanlahir) = 8 Or CInt(bulanlahir) = 10 Or CInt(bulanlahir) = 12 Then
            strDayes = 31
            l9 = "Ter9"
            l10 = "Ter10"
            l11 = "Ter11"
        Else
            If CInt(bulanlahir) = 4 Or CInt(bulanlahir) = 6 Or CInt(bulanlahir) = 9 Or CInt(bulanlahir) = 11 Then
                If tgllahir > 30 Then
                    l9 = "Mbuh"
                    error9 = "Invalid Date"
                Else
        ...
        Else
            If Len(npwp) >= 50 Then
                error33 = "Nomor NPWP maksimal 50 karakter"
                l33 = "Mbuh"
            Else
