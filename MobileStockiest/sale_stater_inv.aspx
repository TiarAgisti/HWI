<%@ Page Title="" Language="VB" MasterPageFile="~/pagesetting/MsPageMS.master" AutoEventWireup="false" CodeFile="sale_stater_inv.aspx.vb" Inherits="MobileStockiest_sale_stater_inv" %>
    ...
    <section class="content-header" style="background-color:white;">
        <div class="panel panel-default" style="margin:10px">
            <div class="panel-heading">
                <h3 class="panel-title text-center">INVOICE PENDAFTARAN DISTRIBUTOR</h3>
            </div>
				        ...
				        <div class="row">
						    ...
						    <div class="col-md-4">
						        <div class="panel panel-default height">
								    ...
								    <div class="panel-body">
                                        <strong>Bulan PV : </strong><%=MonthName(alokbulan)%>&nbsp;<%=aloktahun%><br />
