<%@ Page Title="" Language="VB" MasterPageFile="~/pagesetting/MsPageMS.master" AutoEventWireup="false" CodeFile="akt_verify_ms4.aspx.vb" Inherits="MobileStockiest_akt_verify_ms4" %>
    ...
    <section class="content-header" style="background-color:white;">
        <div class="panel panel-default" style="margin: 10px 10px 10px 10px">
            ...
            <div class="panel-body">
                <form name="theform" method="post" action="akt_aknow_ms4.aspx">
                    <div>
				        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="col-md-12" style="padding: 5px 0px 5px 0px">
							        <span>Silahkan periksa ulang data pendaftaran distrributor baru yang telah anda masukan dibawah ini. Apabila semua sudah benar maka silahkan lanjutkan proses pendaftaran ini dengan mengkik tombol SIMPAN DATA dibawah, namun apabila ada kesalahan pengisian data atau ada perubahan pengisian data, maka silahkan klilk link <-- Kembali --> dibawah. <font color="#FF0000"> <b>Segala konsekuensi yang diakibatkan oleh karena kesalahan pemasukan data sepenuhnya menjadi tanggung jawab distributor yang bersangkutan dan tidak dapat dilakukan revisi. </b></font></span>
                                </div>
                            </div>
                        </div>
			        </div>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="col-md-12" style="padding: 5px 0px 5px 0px">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" readonly name="alamat" value="<%=alamat%>">
                                    </div>
                                ...
                                <div class="col-md-12" style="padding: 5px 0px 5px 0px">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" readonly name="surat" value="<%=surat%>">
                                    </div>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="col-md-12" style="padding: 5px 0px 5px 0px">
                                    ...
                                    <div class="col-md-8">
                                       <input type="text" class="form-control" readonly name="namabank" value="<%=bnk%>">
                                    </div>
						        ...
						        <div class="col-md-12" style="padding: 5px 0px 5px 0px">
                                    ...
                                    <div class="col-md-3">
                                        <input type="text" class="form-control" name="npwp" onKeyDown="if(event.keyCode==13) event.keyCode=9;" value="<%=npwp%>">
                                    </div>
                                    <div class="col-md-5">
                                        <span style="color:red;"><em>*Anda bertanggung jawab sepenuhnya atas kebenaran NPWP yang anda isikan</em></span>
                                    </div>
