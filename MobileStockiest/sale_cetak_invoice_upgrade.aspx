<%@ Page Title="" Language="VB" MasterPageFile="~/pagesetting/MsPageMS.master" AutoEventWireup="false" CodeFile="sale_cetak_invoice_upgrade.aspx.vb" Inherits="MobileStockiest_sale_cetak_invoice_upgrade" %>
                            ...
                            <div class="col-md-4">
                                <div class="panel panel-default height">
                                    <div class="panel-heading text-center">
                                        <strong>INVOICE PAKET UPGRADE</strong>
                                    </div>
                                    <div class="panel-body">
                                        <p style="text-align:center;">
                                            <strong>Bulan PV :&nbsp;</strong><strong><%=MonthName(alokbulan)%>&nbsp;<%=aloktahun%></strong>
                                        </p>
			            ...
			            <div class="table-responsive">
				            <table class="table table-condensed">
					            <thead class="table table-bordered">
						            <tr>
							            <td style="width:25%;" class="table-bordered text-center"><strong>Paket Upgrade</strong></td>
